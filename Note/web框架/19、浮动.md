...
脱标，浮动起来，脱离了标准文档流，致使下一个div盒子标签变为标准文档流的第一个盒子

浮动后，不区分块状元素和行内元素，都支持宽高属性、并排显示

![浮动脱标](D:\wx_work_space\git\wxPythonCode\wxPythonCode\Note\web框架\浮动脱标.png)
...
<head>
    ...
    <style type="text/css">
        ...
        /* 为标签设置float浮动后，标签将不区分块级元素和行内元素，都可以设置width和height，且会并排显示 */
        span{
