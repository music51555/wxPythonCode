# Generated by Django 2.0.1 on 2019-03-11 14:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.CharField(max_length=20, verbose_name='图标')),
                ('menu', models.ForeignKey(blank=True, help_text='如果非空，表示父节点序号，如果为空表示不是二级菜单', null=True, on_delete=True, to='rbac.Menu', verbose_name='父级菜单')),
            ],
        ),
        migrations.CreateModel(
            name='Role',
